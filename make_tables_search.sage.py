...
# This file was *autogenerated* from the file /home/masdeu/orth_new/make_tables_search.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_6 = Integer(6); _sage_const_8 = Integer(8)
import pandas as pd
import time
import os
import glob
    ...
    with open(fname, 'r') as f:
        ...
        for ln in f:
            ...
            if 'Computed' in ln:
                ...
                if 'Jtau = 1' in ln:
                    v1 = copy(val)
                    v1.update({'field' : 'x', 'factor' : 'J = (1)', 'poly' : 'x - 1', 'hpoly' : '-', 'J' : '1', 'trivial' : True, 'recognized' : True, 'o(ζ)' : _sage_const_1 })
                    v2 = copy(v1)
                    v1['char'] = 'triv'
                    v2['char'] = 'conj'
                    ds.extend([v1,v2])
                    ...
                    try:
                        J = QQ(re.search('J[a-z]* = (.[0-9/]*)', ln).groups()[_sage_const_0 ])
...
<link rel='stylesheet' href='https://cdn.datatables.net/v/dt/dt-2.0.7/fh-4.0.1/datatables.min.css'>
        ...
        with tag('body'):
            ...
            doc.asis(df.to_html(classes=['table', 'table-striped', 'table-bordered' ], table_id='dgltable', sparsify=False, escape=False, index=False, columns=columns)[:-_sage_const_8 ]+"<tfoot>\n" + " ".join(["<th>"+ i +"</th>\n" for i in columns])+"</tr>\n  </tfoot></table>")
