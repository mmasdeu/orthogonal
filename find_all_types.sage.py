...
_sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_1000 = Integer(1000); _sage_const_600 = Integer(600); _sage_const_120 = Integer(120); _sage_const_8 = Integer(8); _sage_const_30 = Integer(30); _sage_const_10 = Integer(10); _sage_const_16 = Integer(16); _sage_const_3600 = Integer(3600)
...
def evaluate_cocycle(fname, typ = None, Dmin=_sage_const_1 , Dmax=_sage_const_1000 , outdir='outfiles', log='output.log', prime_bound=_sage_const_600 ):
